...
const GO_KEYWORDS = new Set([
  ...
  'continue', 'go', 'chan', 'make', 'append', 'copy', 'close', 'len', 'cap',
  'defer', 'select', 'map', 'nil', 'true', 'false', 'iota', 'new',
]);
const GO_TYPES = new Set([
  'int', 'int64', 'int32', 'uint', 'uint32', 'uint64', 'bool', 'string',
  'byte', 'error', 'float64', 'uintptr', 'unsafe',
]);
