    ...
    return (
        <div style={{ padding: 12, overflowY: 'auto', flex: 1 }}>
            ...
            >
                ...
                <div>
                    <span style={{ color: 'var(--yellow)' }}>Stack</span> · ~1ns alloc · freed
                    instantly on return · no GC · {s.stackB} B now
                </div>
                <div>
                    <span style={{ color: 'var(--red)' }}>Heap &nbsp;</span> · ~100–200ns alloc · GC
                    marks and sweeps · survives frames · {hStr} now
                </div>
                <div>
                    <span style={{ color: 'var(--purple)' }}>Text &nbsp;</span> · read-only after
                    load · shared between OS processes · no runtime cost
                </div>
                <div>
                ...
                <div style={{ marginTop: 8, color: 'var(--t2)' }}>
                    Goroutine stacks start at <span style={{ color: 'var(--orange)' }}>8 KB</span>{' '}
                    and grow by <span style={{ color: 'var(--orange)' }}>doubling (copystack)</span>{' '}
                    if deeper call chains are needed.
                </div>
                <div>
                    They live on the <span style={{ color: 'var(--red)' }}>heap</span>, NOT the OS
                    thread stack. This allows millions of goroutines with minimal overhead.
                </div>
            </div>
        </div>
    );
