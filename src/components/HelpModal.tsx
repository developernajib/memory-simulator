        ...
        >
            <div className="modal-box">
                ...
                >
                    ...
                    <b style={{ color: 'var(--t2)' }}>CPU Registers</b> tab (or scroll the All
                    Regions view) to watch the x86-64 register file per step:{' '}
                    <b style={{ color: 'var(--t2)' }}>RIP</b> (program counter), instruction
                    register, decoder, <b style={{ color: 'var(--t2)' }}>RSP/RBP</b>, all 16
                    general-purpose registers (64/32/16/8-bit), RFLAGS, segment, SIMD and control
                    registers. Yellow rows changed this step;{' '}
                    <span style={{ color: 'var(--green)' }}>◀ write</span> marks the register the
