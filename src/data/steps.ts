...
// Completed: false = 0 = already zero from mallocgc — SKIP!</span>`,
    ...
    code_seg: [
      { addr: '0x0403000', name: 'main.(*TaskManager).AddTask: field assignments', active: true },
    ],
    data_seg: [],
    heapB: 8769,
    stackB: 104,
    ...
    stack: [
      {
        grp: 'AddTask() frame',
        lbl: 'frame-lbl',
        rows: [{ addr: '0xC000011F20', name: 'tm *TaskManager', val: '0xC000070000', cls: 'ptr' }],
      },
    ],
    heap: [
      {
...
//   temp buffer GC-eligible after Save returns</span>`,
    ...
    goroutines: [
      { id: 'G1', state: 'run', fn: 'FileStorage.Save()', stack: '0xC000010000–0xC000012000' },
    ],
    stack: [
      {
  ...
  },
  {
    ...
    stack: [
      ...
      },
      {
        grp: 'main() frame',
        lbl: 'frame-lbl',
        rows: [{ addr: '0xC000011FB0', name: 'tm *TaskManager', val: '0xC000070000', cls: 'ptr' }],
      },
    ],
    heap: [
      {
...
//   → mallocgc(24 bytes) called at runtime</span>`,
    ...
    data_seg: [
      {
        grp: '.rodata',
        rows: [{ addr: '0x0515000', name: 'time.UTC global', val: 'singleton ptr', cls: 'fn' }],
      },
    ],
    heapB: 8913,
    stackB: 112,
...
// Map escapes to heap (returned as retval)</span>`,
    ...
    goroutines: [
      { id: 'G1', state: 'run', fn: 'GetTasksByPriority()', stack: '0xC000010000–0xC000012000' },
    ],
    stack: [
      {
