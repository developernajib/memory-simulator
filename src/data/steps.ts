...
<span class="cm">// 6. main() called</span>`,
        ...
        goroutines: [
            { id: 'G1', state: 'run', fn: 'runtime init', stack: '0xC000010000–0xC000012000' },
        ],
        stack: [],
        heap: [
            {
                grp: 'G1 goroutine descriptor (runtime.g)',
                lbl: 'heap-lbl',
                rows: [
            ...
            {
                grp: 'M0 OS thread (runtime.m)',
                lbl: 'heap-lbl',
                rows: [
                    { addr: '0xC000046000', name: 'id', val: '0', tag: 'new' },
                    {
                        addr: '0xC000046008',
                        name: 'g0 (sched goroutine)',
                        val: '0xC000048000',
                        cls: 'ptr',
                        tag: 'new',
                    },
        ...
        data_seg: [
            {
                ...
                rows: [
                    ...
                    },
                    {
                        addr: '0x0500050',
                        name: 'errEmptyTitle',
                        val: '"task title cannot be empty"',
                        cls: 'str',
                        tag: 'new',
                    },
                ],
            ...
            {
                grp: '.bss: zero-value globals (iota)',
                rows: [
            ...
            {
                grp: 'itab: interface dispatch tables',
                rows: [
                    {
                        addr: '0x0520000',
                        name: 'itab<FileStorage,TaskStorage>',
                        val: 'Save,Load fn ptrs',
                        cls: 'fn',
                        tag: 'new',
                    },
                ],
    ...
    {
        name: 'main() frame pushed onto G1 stack',
        fn: 'main()',
        group: 'main()',
        tags: ['stack'],
        lines: [208],
...
// No heap allocation yet — frame space is free.</span>`,
        ...
        stack: [
            {
                grp: 'main() frame: freshly pushed, no locals yet',
                lbl: 'frame-lbl',
                rows: [
                    {
                        addr: '0xC000011FE8',
                        name: 'return addr → runtime.goexit',
                        val: '0x0408500',
                        cls: 'ptr',
                        tag: 'new',
                    },
                    {
                        addr: '0xC000011FE0',
                        name: '(locals reserved, not yet written)',
                        val: 'uninitialized',
                        cls: 'nil',
                        tag: 'new',
                    },
        ...
        heap: [
            {
                grp: 'G1 goroutine stack (8 KB, heap-allocated)',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC000010000',
                        name: 'G1 stack.lo',
                        val: 'base of 8KB stack',
                        tag: '',
                    },
                    {
                        addr: '0xC000011FE8',
                        name: 'G1 SP (current)',
                        val: 'stack grows ↓ here',
                        cls: 'ptr',
                    },
                    {
                        addr: '0xC000012000',
    ...
    {
        name: 'interactive = flag.Bool("interactive", false)',
        fn: 'main()',
        group: 'main()',
        tags: ['stack', 'heap'],
        lines: [210],
...
// Default value false is written into the heap bool.</span>`,
        ...
        data_seg: [
            {
                grp: '.rodata: flag name strings (not heap)',
                rows: [
                    {
                        addr: '0x0500060',
                        name: '"interactive" [11B]',
                        val: 'string literal, read-only',
                        cls: 'str',
                    },
                ],
            },
    ...
    {
        name: 'version = flag.Bool("version", false)',
        fn: 'main()',
        group: 'main()',
        tags: ['stack', 'heap'],
        lines: [211],
...
// Both bools share a 16-byte heap allocation unit.</span>`,
        ...
        heap: [
            {
                grp: 'tiny-allocated 16B block @ 0xC000050000',
                lbl: 'heap-lbl',
                rows: [
...
// *addTask is a *string — pointer to a string header</span>`,
        ...
        heap: [
            {
                grp: 'string header @ 0xC000050010 (16 bytes)',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC000050010',
                        name: '*addTask string.ptr',
                        val: 'nil → empty string ""',
                        cls: 'nil',
                        tag: 'new',
                    },
    ...
    {
        name: 'listTasks = flag.Bool("list", false)',
        fn: 'main()',
        group: 'main()',
        tags: ['stack', 'heap'],
        lines: [213],
...
// Stack frame now holds 4 pointers — 32 bytes used.</span>`,
        ...
        stack: [
            {
                grp: 'main() frame: all 4 flag pointers written',
                lbl: 'frame-lbl',
                rows: [
                    {
                        addr: '0xC000011FD8',
        ...
        data_seg: [
            {
                grp: '.rodata: all flag names (string literals, not heap)',
                rows: [
                    {
                        addr: '0x0500060',
                        name: '"interactive"',
    ...
    {
        name: 'flag.Parse(): scanning os.Args',
        fn: 'main()',
        group: 'main()',
        tags: ['stack', 'heap'],
        lines: [215],
...
// Only the heap values at those addresses are updated</span>`,
        ...
        stack: [
            {
                grp: 'main() frame: stack pointers unchanged',
                lbl: 'frame-lbl',
                rows: [
                    {
                        addr: '0xC000011FD8',
        ...
        heap: [
            {
                grp: 'flag heap values: UPDATED by Parse()',
                lbl: 'heap-lbl',
                rows: [
                    { addr: '0xC000050000', name: '*interactive bool', val: 'false', cls: 'bf' },
                    { addr: '0xC000050001', name: '*version bool', val: 'false', cls: 'bf' },
                    {
                        addr: '0xC000050010',
                        name: '*addTask string.ptr',
                        val: "0xC000051000 → 'Fix login bug'",
                        cls: 'ptr',
                        tag: 'upd',
                    },
            ...
            {
                grp: 'parsed string backing @ 0xC000051000',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC000051000',
        ...
        data_seg: [
            {
                grp: '.bss: os.Args slice header (points to kernel-provided argv)',
                rows: [
                    {
                        addr: '0x0511000',
                        name: 'os.Args.ptr',
                        val: 'argv from OS kernel (not heap)',
                        cls: 'ptr',
                    },
                    {
                        addr: '0x0511008',
                        name: 'os.Args.len',
                        val: "3 (argc: task --add 'Fix login bug')",
                    },
                ],
            },
        ],
    ...
    {
        name: 'if *version { fmt.Printf(...); return }',
        fn: 'main()',
        group: 'main()',
        tags: ['stack'],
...
//   return would POP main() frame instantly — no GC needed</span>`,
        ...
        stack: [
            {
                grp: 'main() frame: no change, branch skipped',
                lbl: 'frame-lbl',
                rows: [
                    {
                        addr: '0xC000011FD8',
        ...
        heap: [
            {
                grp: 'flag values (read but not modified)',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC000050001',
                        name: '*version (READ)',
                        val: 'false → branch NOT taken',
                        cls: 'bf',
                    },
                ],
            },
        ...
        data_seg: [
            {
                grp: '.rodata: would be used if branch taken',
                rows: [
                    {
                        addr: '0x0500010',
                        name: 'Version const',
                        val: '"1.0.0" [5B], read-only',
                        cls: 'str',
                    },
                ],
            },
    ...
    {
        name: '&FileStorage{}: escape to heap',
        fn: 'main()',
        group: 'main()',
        tags: ['stack', 'heap'],
        lines: [220, 221],
...
// stack holds only the 8-byte pointer</span>`,
        ...
        heap: [
            {
                grp: 'FileStorage struct (16 bytes) @ 0xC000060000',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC000060000',
                        name: 'filename.ptr',
                        val: '0x0500000 → .rodata',
                        cls: 'ptr',
                        tag: 'new',
                    },
                    {
                        addr: '0xC000060008',
                        name: 'filename.len',
                        val: '10  (string, not slice, no cap)',
                        tag: 'new',
                    },
                ],
            },
        ...
        data_seg: [
            {
                grp: '.rodata (ptr target)',
                rows: [
                    {
                        addr: '0x0500000',
                        name: 'DataFile bytes',
                        val: '"tasks.json" ← filename.ptr',
                        cls: 'str',
                    },
                ],
            },
    ...
    {
        name: 'NewTaskManager(): interface + heap struct',
        fn: 'NewTaskManager()',
        group: 'NewTaskManager()',
...
nextID:  <span class="nu">1</span>,
    ...
    <span class="kw">return</span> tm
        ...
        goroutines: [
            { id: 'G1', state: 'run', fn: 'NewTaskManager()', stack: '0xC000010000–0xC000012000' },
        ],
        stack: [
            {
                grp: 'NewTaskManager() frame',
                lbl: 'frame-lbl',
                rows: [
                    {
                        addr: '0xC000011F60',
                        name: 'storage.itab',
                        val: '0x0520000 (FileStorage itab)',
                        cls: 'ptr',
                        tag: 'new',
                    },
                    {
                        addr: '0xC000011F68',
                        name: 'storage.data',
                        val: '0xC000060000 → FileStorage',
                        cls: 'ptr',
                        tag: 'new',
                    },
                    {
                        addr: '0xC000011F70',
                        name: 'tm *TaskManager (retval)',
                        val: '0xC000070000',
                        cls: 'ptr',
                        tag: 'new',
                    },
        ...
        heap: [
            {
                grp: 'TaskManager (72 bytes) @ 0xC000070000',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC000070000',
                        name: 'tasks.ptr ([]Task)',
                        val: 'nil, no tasks yet',
                        cls: 'nil',
                        tag: 'new',
                    },
            ...
            {
                grp: 'FileStorage @ 0xC000060000 (16 bytes)',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC000060000',
                    ...
                    },
                    {
                        addr: '0xC000060008',
                        name: 'filename.len',
                        val: '10  (string, ptr+len only, no cap)',
                    },
                ],
            },
        ],
    ...
    {
        name: 'NewTaskManager(): storage.Load() via itab',
        fn: 'NewTaskManager()',
        group: 'NewTaskManager()',
        tags: ['stack', 'heap', 'interface'],
...
// NewTaskManager frame POPPED; tm ptr → main()</span>`,
        ...
        goroutines: [
            {
                id: 'G1',
                state: 'run',
                fn: 'main() ← NewTaskManager returning',
                stack: '0xC000010000–0xC000012000',
            },
        ],
        stack: [
            {
                grp: 'main() frame: NewTaskManager frame gone',
                lbl: 'frame-lbl',
                rows: [
                    {
                        addr: '0xC000011FC8',
        ...
        heap: [
            {
                grp: 'TaskManager @ 0xC000070000: tasks still nil',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC000070000',
                        name: 'tasks.ptr',
                        val: 'nil (no saved file found)',
                        cls: 'nil',
                    },
        ...
        data_seg: [
            {
                ...
                rows: [
                    ...
                    {
                        addr: '0x0520010',
                        name: 'itab.fun[1] = Load',
                        val: '0x0406800 → FileStorage.Load',
                        cls: 'fn',
                    },
                ],
            },
    ...
    {
        name: 'AddTask(): input validation TrimSpace',
        fn: '(*TaskManager).AddTask()',
        group: 'AddTask()',
        tags: ['stack'],
...
//   (mutex would never be locked in that path)</span>`,
        ...
        goroutines: [
            { id: 'G1', state: 'run', fn: 'AddTask()', stack: '0xC000010000–0xC000012000' },
        ],
        stack: [
            {
                grp: 'AddTask() frame: newly pushed',
                lbl: 'frame-lbl',
                rows: [
                    {
                        addr: '0xC000011F20',
                    ...
                    {
                        addr: '0xC000011F50',
                        name: 'trimmed.ptr (temp)',
                        val: '0xC000051000 (SAME ptr, no copy!)',
                        cls: 'ptr',
                        tag: 'new',
                    },
                    {
                        addr: '0xC000011F58',
                        name: 'trimmed.len (temp)',
                        val: '13 (no whitespace trimmed)',
                        tag: 'new',
                    },
                ],
            },
        ...
        heap: [
            {
                grp: 'no new allocations: TrimSpace is zero-alloc',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC000051000',
                        name: 'title [13]byte',
                        val: '"Fix login bug", same ptr reused by trimmed',
                        cls: 'str',
                    },
                    {
                        addr: '0xC000070000',
                        name: 'TaskManager (unchanged)',
                        val: 'tasks.len=0, nextID=1, mutex=0',
                        cls: 'nil',
                    },
                ],
            },
        ...
        data_seg: [
            {
                grp: '.rodata: error message ready if validation fails',
                rows: [
                    {
                        addr: '0x0500050',
                        name: 'errEmptyTitle',
  ...
  <span class="kw">defer</span> tm.mutex.<span class="fn">Unlock</span>()  <span class="cm">// ← registered in defer chain</span>`,
        ...
        heap: [
            {
                grp: 'TaskManager: mutex.state LOCKED',
                lbl: 'heap-lbl',
                rows: [
            ...
            {
                grp: 'string backing arrays (caller-allocated)',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC000080000',
    ...
    {
        name: 'task := Task{: escape analysis, mallocgc(88)',
        fn: '(*TaskManager).AddTask()',
        group: 'AddTask()',
        tags: ['stack', 'heap'],
        lines: [132],
...
// Returns pointer to zeroed 88-byte block on heap.</span>`,
        ...
        heap: [
            {
                grp: 'Task (88 bytes, ZEROED) @ 0xC000090000',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC000090000',
                        name: 'ID int',
                        val: '0 (zero, not filled yet)',
                        tag: 'new',
                    },
                    {
                        addr: '0xC000090008',
    ...
    {
        name: 'ID: tm.nextID, Title: title, Priority: priority, Completed: false',
        fn: '(*TaskManager).AddTask()',
        group: 'AddTask()',
        tags: ['stack', 'heap'],
...
// Completed: false = 0 = already zero from mallocgc — SKIP!</span>`,
        ...
        heap: [
            {
                grp: 'Task @ 0xC000090000: fields being written',
                lbl: 'heap-lbl',
                rows: [
                    ...
                    { addr: '0xC000090028', name: 'Priority', val: '1 = Medium', tag: 'upd' },
                    {
                        addr: '0xC000090030',
                        name: 'Completed bool',
                        val: 'false (zero, skip write)',
                        cls: 'bf',
                    },
                    {
                        addr: '0xC000090050',
                        name: 'CompletedAt *time.Time',
                        val: 'nil (zero, skip write)',
                        cls: 'nil',
                    },
                ],
            },
            {
                grp: 'TaskManager: nextID READ for ID field',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC000070028',
                        name: 'nextID (READ)',
                        val: '1 → copied to Task.ID',
                        cls: 'bt',
                    },
        ...
        code_seg: [
            {
                addr: '0x0403000',
                name: 'main.(*TaskManager).AddTask: field assignments',
                active: true,
            },
        ],
        data_seg: [],
    ...
    {
        name: 'CreatedAt: time.Now(), SYSCALL clock_gettime',
        fn: '(*TaskManager).AddTask()',
        group: 'AddTask()',
        tags: ['stack', 'heap'],
        lines: [138],
...
// No heap allocation — time.Time is a VALUE TYPE (24B)</span>`,
        ...
        stack: [
            {
                grp: 'AddTask() frame: time.Time written to heap directly',
                lbl: 'frame-lbl',
                rows: [
                    {
                        addr: '0xC000011F20',
        ...
        heap: [
            {
                grp: 'Task @ 0xC000090000: CreatedAt written',
                lbl: 'heap-lbl',
                rows: [
                    ...
                    { addr: '0xC000090030', name: 'Completed bool', val: 'false', cls: 'bf' },
                    {
                        addr: '0xC000090038',
                        name: 'CreatedAt.wall',
                        val: '13909876543210 (nsec, hasMonotonic bit=1)',
                        tag: 'upd',
                    },
                    {
                        addr: '0xC000090040',
                        name: 'CreatedAt.ext',
                        val: '8765432 (monotonic offset ns)',
                        tag: 'upd',
                    },
                    {
                        addr: '0xC000090048',
                        name: 'CreatedAt.loc *Location',
                        val: '0x0515000 → time.UTC',
                        cls: 'ptr',
                        tag: 'upd',
                    },
                    {
        ...
        data_seg: [
            {
                grp: '.data: time.UTC is a global pointer, NOT heap',
                rows: [
                    {
                        addr: '0x0515000',
                        name: 'time.UTC *Location',
                        val: 'global singleton (data segment)',
                        cls: 'fn',
                    },
                ],
            },
    ...
    {
        name: 'tm.tasks = append(tm.tasks, task): growslice',
        fn: '(*TaskManager).AddTask()',
        group: 'AddTask()',
        tags: ['stack', 'heap'],
        lines: [139, 140],
...
// to tm.tasks in the TaskManager struct on the heap.</span>`,
        ...
        heap: [
            {
                grp: 'TaskManager: tasks slice header UPDATED',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC000070000',
                        name: 'tasks.ptr',
                        val: '0xC0000A0000 (was nil)',
                        cls: 'ptr',
                        tag: 'upd',
                    },
            ...
            {
                grp: 'NEW backing array []Task @ 0xC0000A0000 (mallocgc(88))',
                lbl: 'heap-lbl',
                rows: [
            ...
            {
                grp: 'OLD Task @ 0xC000090000: now unreachable (GC eligible)',
                lbl: 'freed-lbl',
                rows: [
                    {
                        addr: '0xC000090000',
                        name: '(was original task literal)',
                        val: 'no live pointer → GC will reclaim',
                        cls: 'stale',
                        tag: 'free',
                    },
                ],
    ...
    {
        name: 'tm.nextID++: in-place heap increment (ADDQ)',
        fn: '(*TaskManager).AddTask()',
        group: 'AddTask()',
        tags: ['stack', 'heap'],
        lines: [141],
...
// goroutine can race this write.</span>`,
        ...
        heap: [
            {
                grp: 'TaskManager: nextID incremented',
                lbl: 'heap-lbl',
                rows: [
                    { addr: '0xC000070028', name: 'nextID int', val: '2 (was 1)', tag: 'upd' },
                    {
                        addr: '0xC000070030',
                        name: 'mutex.state',
                        val: '1 = LOCKED (protecting this write!)',
                        cls: 'bt',
                    },
        ...
        code_seg: [
            { addr: '0x0403000', name: 'main.(*TaskManager).AddTask: ADDQ nextID', active: true },
        ],
        data_seg: [],
        heapB: 8889,
        stackB: 80,
    ...
    {
        name: 'AddTask(): storage.Save() interface dispatch',
        fn: '(*TaskManager).AddTask()',
        group: 'AddTask()',
        tags: ['stack', 'heap', 'interface'],
        lines: [142],
...
//   temp buffer GC-eligible after Save returns</span>`,
        ...
        stack: [
            {
                grp: 'FileStorage.Save() frame',
                lbl: 'frame-lbl',
                rows: [
                    {
                        addr: '0xC000011EE0',
                        name: 'fs *FileStorage receiver',
                        val: '0xC000060000',
                        cls: 'ptr',
                        tag: 'new',
                    },
                    ...
                    {
                        addr: '0xC000011EF8',
                        name: 'data []byte (JSON buf)',
                        val: '0xC000052000 (temp)',
                        cls: 'ptr',
                        tag: 'new',
                    },
                    {
        ...
        heap: [
            {
                grp: 'JSON encode buffer (temp) @ 0xC000052000',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC000052000',
                        name: '[]byte JSON output',
                        val: '[{"id":1,"title":"Fix login bug",...}]',
                        cls: 'str',
                        tag: 'new',
                    },
                    {
                        addr: '0xC000052100',
                        name: '(over-allocated cap)',
                        val: '~256 B, standard allocator behavior',
                        tag: 'new',
                    },
                ],
            },
            {
                grp: 'TaskManager: itab used for dispatch',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC000070018',
                        name: 'storage.itab',
                        val: '0x0520000, dispatch source',
                        cls: 'ptr',
                    },
                    { addr: '0xC000070000', name: 'tasks.ptr', val: '0xC0000A0000', cls: 'ptr' },
                    { addr: '0xC000070030', name: 'mutex.state', val: '1 = LOCKED', cls: 'bt' },
    ...
    {
        name: 'defer + mutex.Unlock() + return',
        fn: '(*TaskManager).AddTask()',
        group: 'AddTask()',
        tags: ['stack', 'mutex'],
  ...
  // No GC needed for stack memory</span>`,
        ...
        stack: [
            {
                grp: 'main() frame — AddTask frame GONE',
                lbl: 'frame-lbl',
                rows: [
                    {
                        addr: '0xC000011FB0',
        ...
        heap: [
            {
                grp: 'TaskManager — mutex UNLOCKED',
                lbl: 'heap-lbl',
                rows: [
                    { addr: '0xC000070000', name: 'tasks.ptr', val: '0xC0000A0000', cls: 'ptr' },
                    { addr: '0xC000070008', name: 'tasks.len', val: '1' },
    ...
    {
        name: 'GetTasks() — RLock + make copy',
        fn: '(*TaskManager).GetTasks()',
        group: 'GetTasks()',
    ...
    <span class="kw">return</span> tasksCopy
        ...
        goroutines: [
            { id: 'G1', state: 'run', fn: 'GetTasks()', stack: '0xC000010000–0xC000012000' },
        ],
        stack: [
            {
                grp: 'GetTasks() frame',
        ...
        heap: [
            {
                grp: 'NEW copy of []Task @ 0xC0000B0000 (88 bytes)',
                lbl: 'heap-lbl',
                rows: [
                    { addr: '0xC0000B0000', name: 'copy[0].ID', val: '1', tag: 'new' },
                    {
                        addr: '0xC0000B0008',
                        name: 'copy[0].Title.ptr',
                        val: '0xC000080000',
                        cls: 'ptr',
                        tag: 'new',
                    },
            ...
            {
                grp: 'TaskManager — readerCount incremented',
                lbl: 'heap-lbl',
                rows: [
                    { addr: '0xC000070030', name: 'mutex.state', val: '0 = unlocked' },
                    {
                        addr: '0xC000070040',
                        name: 'mutex.readerCount',
                        val: '1 (reading)',
                        cls: 'bt',
                        tag: 'upd',
                    },
    ...
    {
        name: 'CompleteTask() + MarkComplete() — pointer escape',
        fn: '(*Task).MarkComplete()',
        group: 'CompleteTask()',
        tags: ['stack', 'heap', 'mutex'],
...
//   → mallocgc(24 bytes) called at runtime</span>`,
        ...
        goroutines: [
            { id: 'G1', state: 'run', fn: 'MarkComplete()', stack: '0xC000010000–0xC000012000' },
        ],
        stack: [
            {
                grp: 'MarkComplete() frame',
                lbl: 'frame-lbl',
                rows: [
                    {
                        addr: '0xC000011EE0',
                        name: 't *Task receiver',
                        val: '0xC0000A0000 → tasks[0]',
                        cls: 'ptr',
                        tag: 'new',
                    },
                    {
                        addr: '0xC000011EE8',
                        name: 'now → ESCAPED',
                        val: '(moved to heap 0xC0000C0000)',
                        cls: 'nil',
                        tag: 'new',
                    },
                ],
        ...
        heap: [
            ...
            {
                grp: 'time.Time (escaped from stack) @ 0xC0000C0000',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC0000C0000',
            ...
            },
            {
                grp: 'TaskManager',
                lbl: 'heap-lbl',
                rows: [{ addr: '0xC000070030', name: 'mutex.state', val: '1 = LOCKED', cls: 'bt' }],
            },
        ],
        code_seg: [
    ...
    {
        name: 'DeleteTask() — slice re-slice trick',
        fn: '(*TaskManager).DeleteTask()',
        group: 'DeleteTask()',
        tags: ['stack', 'heap', 'mutex'],
...
//   → tasks.len-- on the heap header</span>`,
        ...
        goroutines: [
            { id: 'G1', state: 'run', fn: 'DeleteTask()', stack: '0xC000010000–0xC000012000' },
        ],
        stack: [
            {
                grp: 'DeleteTask() frame',
                lbl: 'frame-lbl',
                rows: [
                    ...
                    {
                        addr: '0xC000011F10',
                        name: 'task Task (VALUE COPY)',
                        val: 'copy of tasks[0] — 88B on stack',
                        tag: 'new',
                    },
                ],
            },
        ...
        heap: [
            {
                grp: 'TaskManager — after delete',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC000070000',
                        name: 'tasks.ptr',
                        val: '0xC0000A0000 (same)',
                        cls: 'ptr',
                    },
            ...
            {
                grp: 'backing array — stale data past len=0',
                lbl: 'freed-lbl',
                rows: [
                    {
                        addr: '0xC0000A0000',
                        name: '[0] (past len, stale)',
                        val: 'unreachable → GC eligible',
                        cls: 'stale',
                        tag: 'free',
                    },
                ],
    ...
    {
        name: 'GetTasksByPriority() — hmap & bucket alloc',
        fn: '(*TaskManager).GetTasksByPriority()',
        group: 'Bonus Methods',
        tags: ['stack', 'heap', 'mutex'],
...
// Map escapes to heap (returned as retval)</span>`,
        ...
        goroutines: [
            {
                id: 'G1',
                state: 'run',
                fn: 'GetTasksByPriority()',
                stack: '0xC000010000–0xC000012000',
            },
        ],
        stack: [
            {
                grp: 'GetTasksByPriority() frame',
                lbl: 'frame-lbl',
                rows: [
                    {
                        addr: '0xC000011F00',
                    ...
                    {
                        addr: '0xC000011F10',
                        name: 'loop: task (88B value copy)',
                        val: 'copy of tasks[0] on stack',
                        tag: 'new',
                    },
                ],
            },
        ...
        heap: [
            {
                grp: 'hmap struct @ 0xC0000E0000 (56 bytes)',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC0000E0000',
                        name: 'count int',
                        val: '1 (one entry added)',
                        tag: 'new',
                    },
                    {
                        addr: '0xC0000E0008',
                        name: 'flags uint8',
                        val: '0 (not currently writing)',
                        tag: 'new',
                    },
                    {
                        addr: '0xC0000E0009',
                        name: 'B uint8',
                        val: '0 (log2 nBuckets = 1 bucket)',
                        tag: 'new',
                    },
                    {
                        addr: '0xC0000E000C',
                        name: 'hash0 uint32',
                        val: '0xA1B2C3D4 (random seed)',
                        tag: 'new',
                    },
                    {
                        addr: '0xC0000E0010',
                        name: 'buckets unsafe.Ptr',
                        val: '0xC0000F0000',
                        cls: 'ptr',
                        tag: 'new',
                    },
            ...
            {
                grp: 'bucket @ 0xC0000F0000 — 8 slots (key=Priority 8B, val=[]Task 24B)',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC0000F0000',
                        name: 'tophash[0..7]',
                        val: '[0x82, 0, 0, 0, 0, 0, 0, 0]',
                        tag: 'new',
                    },
                    {
                        addr: '0xC0000F0008',
                        name: 'keys[0] Priority',
                        val: '1 (Medium)',
                        tag: 'new',
                    },
                    {
                        addr: '0xC0000F0010',
                        name: 'values[0] []Task.ptr',
                        val: '0xC0000A0000',
                        cls: 'ptr',
                        tag: 'new',
                    },
    ...
    {
        name: 'ProcessTasksAsync() — goroutines + channels',
        fn: '(*TaskManager).ProcessTasksAsync()',
        group: 'Goroutines',
...
<span class="kw">for</span> i := <span class="num">0</span>; i < MaxWorkers; i++ { <-done }`,
        ...
        stack: [
            {
                grp: 'ProcessTasksAsync() frame (G1)',
                lbl: 'frame-lbl',
                rows: [
                    {
                        addr: '0xC000011ED0',
                        name: 'taskChan chan Task',
                        val: '0xC0000D0000',
                        cls: 'ptr',
                        tag: 'new',
                    },
                    ...
                    {
                        addr: '0xC000011EE0',
                        name: 'tasks []Task hdr (copy)',
                        val: 'ptr=0xC0000B0000 len=1',
                        tag: 'new',
                    },
                ],
            },
        ...
        heap: [
            {
                grp: 'hchan (taskChan) ring buffer @ 0xC0000D0000',
                lbl: 'heap-lbl',
                rows: [
                    ...
                    },
                    {
                        addr: '0xC0000D0010',
                        name: 'buf unsafe.Ptr',
                        val: '0xC0000D0080 → [Task]',
                        cls: 'ptr',
                        tag: 'new',
                    },
                    {
                        addr: '0xC0000D0018',
                        name: 'elemsize uint16',
                        val: '88 (sizeof Task)',
                        tag: 'new',
                    },
            ...
            {
                grp: 'G2 descriptor + 8KB stack @ 0xC000100000',
                lbl: 'heap-lbl',
                rows: [
                    ...
                    },
                    {
                        addr: '0xC0000E0010',
                        name: 'G2.status',
                        val: '4 = Gwaiting (chan recv)',
                        tag: 'new',
                    },
                ],
            },
            {
                grp: 'G3 descriptor + 8KB stack @ 0xC000102000',
                lbl: 'heap-lbl',
                rows: [
            ...
            {
                grp: 'G4 descriptor + 8KB stack @ 0xC000104000',
                lbl: 'heap-lbl',
                rows: [
        ...
        data_seg: [
            {
                grp: '.bss',
                rows: [{ addr: '0x0510010', name: 'MaxWorkers const', val: '3' }],
            },
        ],
        heapB: 41880,
        stackB: 96,
    ...
    {
        name: 'ProcessTasksAsync() — channel send & goroutine wake',
        fn: '(*TaskManager).ProcessTasksAsync()',
        group: 'Goroutines',
        tags: ['heap', 'goroutine'],
...
//   skipping the ring buffer entirely</span>`,
        ...
        goroutines: [
            ...
            { id: 'G2', state: 'run', fn: 'processor(task)', stack: '0xC000100000' },
            {
                id: 'G3',
                state: 'wait',
                fn: 'range taskChan (idle, ch closed)',
                stack: '0xC000102000',
            },
            {
                id: 'G4',
        ...
        stack: [
            {
                grp: 'G2 worker frame (currently running)',
                lbl: 'frame-lbl',
                rows: [
                    {
                        addr: '0xC000100F80',
        ...
        heap: [
            {
                grp: 'hchan (taskChan) — after send+recv',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC0000D0000',
                        name: 'qcount uint',
                        val: '0 (sent and consumed)',
                        tag: 'upd',
                    },
                    ...
                    },
                    {
                        addr: '0xC0000D0080',
                        name: 'ring[0] Task',
                        val: '(delivered — consumed by G2)',
                        cls: 'nil',
                    },
                ],
            },
            {
                grp: 'G1 status — blocked',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC000044018',
    ...
    {
        name: 'GC Phase 0 — trigger: heapAlloc exceeds gcTrigger',
        fn: 'runtime.gcStart()',
        group: 'GC',
        tags: ['gc', 'heap'],
        lines: [],
...
//   sends signal to all Ps to begin GC assistance</span>`,
        ...
        stack: [
            {
                grp: 'main() frame — G1 was doing a normal alloc',
                lbl: 'frame-lbl',
                rows: [
                    {
                        addr: '0xC000011FB0',
        ...
        heap: [
            {
                grp: 'GC state transition',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0x0518010',
                        name: 'gcphase (global)',
                        val: '_GCmark (was _GCoff)',
                        tag: 'upd',
                    },
                    {
                        addr: '0x0518020',
                        name: 'writeBarrier.enabled',
                        val: '1 (ON — was 0)',
                        cls: 'bt',
                        tag: 'upd',
                    },
                    {
                        addr: '0x0518000',
                        name: 'gcController.heapLive',
                        val: '~41 KB (current)',
                        tag: '',
                    },
                    {
                        addr: '0x0518008',
                        name: 'gcController.gcTrigger',
                        val: '~40 KB threshold',
                        tag: '',
                    },
                ],
        ...
        data_seg: [
            {
                grp: 'GC control variables in .data',
                rows: [
                    {
                        addr: '0x0518000',
                        name: 'gcController struct',
                        val: 'heapLive, heapMarked, triggerRatio',
                    },
                    {
                        addr: '0x0518100',
                        name: 'mheap_ global struct',
                        val: 'all heap spans, free lists, mcentral',
                    },
                    {
                        addr: '0x0518200',
                        name: 'work struct',
                        val: 'markrootNext, nproc, nwait counters',
                    },
                ],
            },
        ],
    ...
    {
        name: 'GC Phase 1 — STW: stop all goroutines, scan roots',
...
//   - CPU registers of each goroutine</span>`,
        ...
        stack: [
            {
                grp: 'G1 stack — SCANNED for roots (ALL ptrs recorded)',
                lbl: 'frame-lbl',
                rows: [
                    {
                        addr: '0xC000011FB0',
                        name: 'tm *TaskManager → ROOT',
                        val: '0xC000070000 — traced!',
                        cls: 'ptr',
                        tag: 'upd',
                    },
                    {
                        addr: '0xC000011FB8',
                        name: 'storage *FileStorage → ROOT',
                        val: '0xC000060000 — traced!',
                        cls: 'ptr',
                        tag: 'upd',
                    },
                ],
        ...
        heap: [
            {
                grp: 'Root set (what GC will trace from)',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: 'STACK',
                        name: 'G1 stack ptrs',
                        val: 'tm→0xC000070000, storage→0xC000060000',
                        cls: 'bt',
                        tag: 'new',
                    },
                    {
                        addr: 'GLOBAL',
                        name: '.data globals',
                        val: 'gcController, mheap_, time.UTC, itab tables',
                        cls: 'bt',
                        tag: 'new',
                    },
                    {
                        addr: 'REGS',
                        name: 'CPU registers',
                        val: 'AX/BX/CX/DX/R8... saved in goroutine context',
                        cls: 'bt',
                        tag: 'new',
                    },
                    {
                        addr: 'GSCHED',
                        name: 'G descriptors',
                        val: 'G1/G2/G3/G5 always reachable',
                        cls: 'bt',
                        tag: 'new',
                    },
                ],
        ...
        data_seg: [
            {
                grp: 'globals that are GC roots',
                rows: [
                    {
                        addr: '0x0515000',
                        name: 'time.UTC global',
                        val: 'root — always reachable',
                        cls: 'fn',
                    },
                    {
                        addr: '0x0520000',
    ...
    {
        name: 'GC Phase 2 — concurrent mark: trace all live objects',
...
//   Prevents "black object points to white object" bug</span>`,
        ...
        stack: [
            {
                grp: 'main() frame — G1 running normally (with WB)',
                lbl: 'frame-lbl',
                rows: [
                    {
                        addr: '0xC000011FB0',
                        name: 'tm *TaskManager',
                        val: '0xC000070000 ← BLACK (marked)',
                        cls: 'ptr',
                    },
                    {
                        addr: '0xC000011FB8',
                        name: 'storage *FileStorage',
                        val: '0xC000060000 ← BLACK',
                        cls: 'ptr',
                    },
                ],
            },
        ...
        heap: [
            {
                grp: 'Mark status of heap objects',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0xC000070000',
                        name: 'TaskManager',
                        val: 'BLACK — fully scanned',
                        cls: 'bt',
                    },
                    {
                        addr: '0xC000060000',
                    ...
                    {
                        addr: '0xC0000A0000',
                        name: '[]Task backing array',
                        val: 'BLACK — reached via tasks.ptr',
                        cls: 'bt',
                    },
                    {
                        addr: '0xC000051000',
                        name: 'title string bytes',
                        val: 'BLACK — reached via [0].Title.ptr',
                        cls: 'bt',
                    },
                    {
                        addr: '0xC0000C0000',
                        name: 'time.Time (escaped now)',
                        val: 'BLACK — reached via CompletedAt ptr',
                        cls: 'bt',
                    },
                    {
                        addr: '0xC000044000',
                        name: 'G1 descriptor',
                        val: 'BLACK — goroutine always live',
                        cls: 'bt',
                    },
                    {
                        addr: '0xC000090000',
                        name: 'old Task copy (unreachable)',
                        val: 'WHITE — no pointer points here',
                        cls: 'nil',
                    },
                    {
                        addr: '0xC0000B0000',
                        name: 'GetTasks() copy (gone)',
                        val: 'WHITE — caller returned, no ref',
                        cls: 'nil',
                    },
                ],
            },
            {
                grp: 'Write barrier shading (if G1 writes new ptr during mark)',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: 'WB-LOG',
                        name: 'writeBarrier log buffer',
                        val: 'records old+new ptr values → shade grey',
                        cls: 'ptr',
                    },
                ],
            },
        ...
        data_seg: [
            {
                ...
                rows: [
                    {
                        addr: '0x0518200',
                        name: 'work.markrootNext',
                        val: 'root iterator — all roots done',
                        cls: 'fn',
                    },
                    {
                        addr: '0x0518300',
                        name: 'gcWork.balance',
                        val: 'items in grey queue',
                        cls: 'fn',
                    },
                ],
            },
    ...
    {
        name: 'GC Phase 3 — mark termination STW: drain queues, finalize',
...
// After this: goroutines resume, sweep runs concurrently.</span>`,
        ...
        goroutines: [
            { id: 'G1', state: 'wait', fn: 'STW mark termination', stack: '0xC000010000' },
            {
                id: 'G5 GC',
                state: 'run',
                fn: 'gcMarkTermination — drain final grey',
                stack: '0xC000110000',
            },
        ],
        stack: [
            {
                grp: 'G1 parked at safe point (second STW)',
                lbl: 'frame-lbl',
                rows: [
                    {
                        addr: '0xC000011FB0',
        ...
        heap: [
            {
                grp: 'GC state after mark termination',
                lbl: 'heap-lbl',
                rows: [
                    {
                        addr: '0x0518010',
                        name: 'gcphase',
                        val: '_GCoff (mark done)',
                        cls: 'bt',
                        tag: 'upd',
                    },
                    {
                        addr: '0x0518020',
                        name: 'writeBarrier.enabled',
                        val: '0 (OFF — barrier cost gone)',
                        cls: 'bf',
                        tag: 'upd',
                    },
                    {
                        addr: '0x0518028',
                        name: 'gcController.heapMarked',
                        val: '~8.5 KB (live heap snapshot)',
                        tag: 'upd',
                    },
                    {
                        addr: '0x0518030',
                        name: 'gcController.gcTrigger',
                        val: '~17 KB (next trigger = 2× marked)',
                        tag: 'upd',
                    },
                ],
            },
            {
                grp: 'All white objects are now unreachable (confirmed)',
                lbl: 'freed-lbl',
                rows: [
                    {
                        addr: '0xC000090000',
                        name: 'old Task copy',
                        val: 'WHITE → will be swept',
                        cls: 'stale',
                    },
                    {
                        addr: '0xC0000B0000',
                        name: 'GetTasks() copy array',
                        val: 'WHITE → will be swept',
                        cls: 'stale',
                    },
                    {
                        addr: '0xC000052000',
                        name: 'JSON encode buffer (temp)',
                        val: 'WHITE → will be swept',
                        cls: 'stale',
                    },
                ],
        ...
        data_seg: [
            {
                grp: 'Updated GC stats',
                rows: [
                    {
                        addr: '0x0518028',
                        name: 'heapMarked',
                        val: 'locked in — baseline for next gcTrigger',
                    },
                ],
            },
        ],
    ...
    {
        name: 'GC Phase 4 — concurrent sweep: reclaim white spans',
        fn: 'runtime.sweepone()',
        group: 'GC',
        tags: ['gc', 'heap'],
        lines: [],
...
// The old Task copy at 0xC000090000 is swept here.</span>`,
        ...
        goroutines: [
            {
                id: 'G1',
                state: 'run',
                fn: 'user code (normal, no write barrier)',
                stack: '0xC000010000',
            },
        ...
        stack: [
            {
                grp: 'main() frame — G1 running at full speed',
                lbl: 'frame-lbl',
                rows: [
                    {
                        addr: '0xC000011FB0',
        ...
        heap: [
            {
                grp: 'LIVE — black (marked) objects remain',
                lbl: 'heap-lbl',
                rows: [
                    ...
                    {
                        addr: '0xC000051000',
                        name: 'title string [13]byte',
                        val: 'LIVE — in use',
                        cls: 'bt',
                    },
                    {
                        addr: '0xC000044000',
                        name: 'G1 descriptor + 8KB stack',
                        val: 'LIVE — goroutine running',
                        cls: 'bt',
                    },
                ],
            },
            {
                grp: 'SWEPT — reclaimed, returned to mheap_ free lists',
                lbl: 'freed-lbl',
                rows: [
                    {
                        addr: '0xC000090000',
                        name: 'old Task literal',
                        val: 'FREED → span.freelist (88B slot available)',
                        cls: 'stale',
                        tag: 'free',
                    },
                    {
                        addr: '0xC0000B0000',
                        name: 'GetTasks() copy array',
                        val: 'FREED → span.freelist',
                        cls: 'stale',
                        tag: 'free',
                    },
                    {
                        addr: '0xC000052000',
                        name: 'JSON encode buffer',
                        val: 'FREED → mheap_.free (span empty)',
                        cls: 'stale',
                        tag: 'free',
                    },
                    {
                        addr: '0xC0000D0000',
                        name: 'hchan (taskChan, closed)',
                        val: 'FREED → returned to mheap_',
                        cls: 'stale',
                        tag: 'free',
                    },
                ],
        ...
        data_seg: [
            {
                grp: 'mheap_ free lists updated',
                rows: [
                    {
                        addr: '0x0518100',
                        name: 'mheap_.free',
                        val: 'span at 0xC000090xxx returned',
                        cls: 'fn',
                    },
                    {
                        addr: '0x0518140',
                        name: 'mheap_.scav',
                        val: 'candidates for OS return (idle >5min)',
                        cls: 'fn',
                    },
                ],
            },
